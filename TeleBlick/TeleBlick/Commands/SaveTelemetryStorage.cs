...
namespace TeleBlick.Commands
{
    ...
    public class SaveTelemetryStorage : TeleBlickCommand
    {
        ...
        public override async Task ExecuteAsync(object? parameter)
        {
            ...
            if (provider != null)
            {
                var file = await provider.SaveFilePickerAsync(_saveOptions);
                if (file != null)
                {
                }
            }
